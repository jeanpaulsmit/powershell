...
(
    ...
    [Parameter(HelpMessage="The location of the certificate to use for the service principal")] 
    [String] $certPath,

    [Parameter(HelpMessage="The password of the certificate to use for the service principal")] 
...
else
{
    ...
    $azureAdApplication = New-AzureRmADApplication -DisplayName $displayName -HomePage $homePage -IdentifierUris $identifierUri -KeyCredentials $keyCredential -Verbose
